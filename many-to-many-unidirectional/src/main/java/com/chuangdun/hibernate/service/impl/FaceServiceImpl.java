...
public class FaceServiceImpl implements FaceService {
    ...
    public void saveCascade() {
        ...
        face1.getTags().add(tag1);
        face1.getTags().add(tag2);
        face2.getTags().add(tag1);

        faceRepository.save(face1);
        faceRepository.save(face2);
    }
    ...
    public void removeTag() {
        Face face = faceRepository.getOne(1L);
        face.getTags().remove(0);
